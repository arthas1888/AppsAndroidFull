package com.example.a68.listapplication.fragments;
...
import com.example.a68.listapplication.adapters.CustomAdapter;
...
public class ListaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        personas.add(new Persona("Andres", "Gutierrez", 23));
        personas.add(new Persona("Alex", "Garcia", 25));

        CustomAdapter customAdapter = new CustomAdapter(getActivity(), personas);
